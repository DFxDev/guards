...
const Profile = ({ guardData }) => {
  ...
  useEffect(() => {
    setFormData({
      ...
      gender: guardData?.gender,
      photo: guardData?.photo,
      phone: guardData?.phone,
      bio: guardData?.bio,
      qualifications: guardData?.qualifications,
      experiences: guardData?.experiences,
      about: guardData?.about,
      ticketPrice: guardData?.ticketPrice,
      specialization: guardData?.specialization,
      timeSlots: guardData?.timeSlots,
    });
  }, [guardData]);
  ...
  const updateguardHandler = async e => {
    e.preventDefault();
    console.log(formData);
    try {
      const res = await fetch(`${BASE_URL}/guards/${guardData._id}`, {
        method: "put",
        headers: {
      ...
      <form>
        <div className="mb-5">
          ...
          <input
            ...
            className="form__input border-[#00c8ff]"
          />
        </div>
        <div className="mb-5">
          ...
          <div className="grid grid-cols-3 gap-5 mb-[30px]">
            <div>
              ...
              <select
                ...
                onChange={handleInputChange}
                className="form__input py-3.5 border-[#00c8ff]"
              >
            ...
            <div key={index}>
              <div>
                ...
                <div className="grid grid-cols-2 gap-5 mt-5">
                  <div>
                    <p className="form__label">Education*</p>
                    <input
                      type="text"
                      name="degree"
                      value={item.degree}
                  ...
                  <div>
                    <p className="form__label">School*</p>
                    <input
                      type="text"
                      name="university"
...
{/* 
        ...
        <div className="mb-5 flex items-center gap-3">
          {formData.photo && (
            <figure className="w-[60px] h-[60px] rounded-full border-2 border-solid border-[#00c8ff] flex items-center justify-center">
              <img
                src={formData.photo}
                alt="Preview"
          ...
          <div className="relative inline-block w-[130px] h-[50px]">
            ...
            <label
              className="custom-file-label absolute top-0 left-0 w-full h-full flex items-center px-[0.75rem] py-[0.375rem] text-[15px] leading-6 overflow-hidden bg-sky-400 text-headingColor font-semibold rounded-lg truncate cursor-pointer"
              htmlFor="customFile"
            >
