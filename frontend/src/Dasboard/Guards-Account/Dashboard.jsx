...
import GuardAbout from "../../pages/Guards/GuardAbout";
...
const Dashboard = () => {
  ...
  const {
    ...
    loading,
    error,
  } = useGetProfile(`${BASE_URL}/guards/profile/me`);
          ...
          <div className="grid lg:grid-cols-3 gap-[30px] lg:gap-[50px] ">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="mt-8">
                  ...
                  <div>
                    <div className="flex gap-5 items-center mb-10">
                      <figure className="max-w-[200px] max-h-[200px]">
                        <img src={guardData.photo} alt="" className="w-full" />
                      </figure>
                      <div>
                        ...
                        <div className="flex items-center gap-[6px]">
                          <span className="flex items-center gap-[6px] text-[14px] leading-6 lg:text-[16px] lg:leading-7 font-[600] text-headingColor">
                            ...
                            {guardData.averageRating}
                          </span>
                          <span className="text-[14px] leading-6 lg:text-[16px] lg:leading-7 font-[400] text-textColor">
                            ({guardData.totalRating})
                          </span>
                        </div>
                ...
                {tab === "settings" && <Profile guardData={guardData} />}
                
                {tab === "appointments" && (
                  <Appointments appointments={guardData.appointments} />
                )}
