...
const Tabs = ({ tab, setTab }) => {
  ...
  return (
    <div>
      ...
      <div
        ref={tabsRef}
        className="hidden lg:flex items-center shadow-panelShadow  h-max p-[30px] mr-[20px] bg-white  flex-col rounded-md"
      >
        <button
          onClick={() => setTab("overview")}
          className={` ${
            tab === "overview"
              ? "bg-sky-50 text-[#3d98b1]"
